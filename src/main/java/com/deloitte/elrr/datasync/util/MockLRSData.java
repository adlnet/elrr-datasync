...
public class MockLRSData {
	...
	private static Statement getStatement1() {
		...
		statement.setActor(getAgentActor("Cristopher Cunningham","mailto:c.cooper3@yahoo.com"));
	    statement.setId("4859303f-8237-46d2-8bf3-186069514eb7");
	    statement.setObject(getObject("http://adlnet.gov/expapi/activities/example/CLC%20104","Analyzing Profit or Fee")); 
	...
	private static Statement getStatement2() {
		Statement statement = createStatement();
		statement.setActor(getAgentActor("Bill Phillips","mailto:b.phillp3@hotmail.com"));
	    statement.setId("700dc3e1-2eb1-416f-9cad-b20c9bf33a93");
	    statement.setObject(getObject("http://adlnet.gov/expapi/activities/example/RQM%20310","Advanced Concepts and Skills for Requirements Management"));
	...
	private static Verb getVerb(String string) {
		Verb verb = new Verb();
	...
	private static IStatementObject getObject(String id, String courseName) {
	...
	private static Actor getAuthority() {
		...
		Account account = new Account();
	     account.setHomePage("https://deloitte-prototype-noisy.lrs.io/keys/ELRR_Validation");
